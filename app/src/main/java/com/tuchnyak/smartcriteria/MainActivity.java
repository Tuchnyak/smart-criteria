...
//        smartProject.increaseCurrentProgress();
        ...
        fakeCurrentData.put(new Date(startDay.getTime()), 253f);
        fakeCurrentData.put(new Date(startDay.getTime() + 1 * 24 * 60 * 60 * 100), 247f);
        fakeCurrentData.put(new Date(startDay.getTime() + 2 * 24 * 60 * 60 * 100), 234f);
        fakeCurrentData.put(new Date(startDay.getTime() + 3 * 24 * 60 * 60 * 100), 234f);
        fakeCurrentData.put(new Date(startDay.getTime() + 4 * 24 * 60 * 60 * 100), 217f);
        fakeCurrentData.put(new Date(startDay.getTime() + 5 * 24 * 60 * 60 * 100), 206f);
        fakeCurrentData.put(new Date(startDay.getTime() + 6 * 24 * 60 * 60 * 100), 201f);
        fakeCurrentData.put(new Date(startDay.getTime() + 7 * 24 * 60 * 60 * 100), 188f);
        fakeCurrentData.put(new Date(startDay.getTime() + 8 * 24 * 60 * 60 * 100), 169f);
        fakeCurrentData.put(new Date(startDay.getTime() + 9 * 24 * 60 * 60 * 100), 154f);
        fakeCurrentData.put(new Date(startDay.getTime() + 10 * 24 * 60 * 60 * 100), 143f);
        fakeCurrentData.put(new Date(startDay.getTime() + 11 * 24 * 60 * 60 * 100), 140f);
        fakeCurrentData.put(new Date(startDay.getTime() + 12 * 24 * 60 * 60 * 100), 132f);

        smartProject.setEntriesCurrentPace(fakeCurrentData);
        smartProject.fillGaps();
